...
exports.createClient = function(neo4j_options, redis_options) {
  neo4j_options = neo4j_options || {};

  var
    neo4jClient = neo4j.createClient(neo4j_options),
    redis_host = redis_options.host || 'localhost',
    redis_port = redis_options.port || 6379,
    redisClient = redis.createClient(redis_port, redis_host),
    pending = new events.EventEmitter();

  pending.setMaxListeners(0); // unlimited

  neo4jClient.expiry = neo4j_options.expiry || 300; // default 5 min
